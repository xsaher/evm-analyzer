...
def fetch_function_signatures(contract_address: str) -> dict[str, str]:
    """
    Pulls verified ABI from Etherscan and returns a map of
    4-byte selector -> human-readable function signature.
    Falls back to empty dict if contract is not verified.
    """
    params = {
        "module": "contract",
        "action": "getabi",
